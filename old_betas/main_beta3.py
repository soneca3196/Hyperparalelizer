# python main_beta3.py server --port 9000 --fragments 10 --min-peers 2 --peer-wait-timeout 30 --stop-when-complete
# python main_beta3.py peer --host 127.0.0.1 --port 9101 --server-host 127.0.0.1 --server-port 9000 --reset-storage
# python main_beta3.py peer --host 127.0.0.1 --port 9102 --server-host 127.0.0.1 --server-port 9000 --reset-storage


from __future__ import annotations

"""main_beta3.py - bootstrap e orquestração do Hyperparalelizer.
...
Uso:
    python main_beta3.py server --host 127.0.0.1 --port 9000 --fragments 10
    python main_beta3.py peer --host 127.0.0.1 --port 9101 \
        --server-host 127.0.0.1 --server-port 9000 --reset-storage
"""
